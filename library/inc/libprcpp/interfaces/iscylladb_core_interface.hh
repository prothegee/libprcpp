...
public:
    ...
    struct SIScyllaDb
    {
         ...
         */
        EScyllaDbTopologyStrat getStrategy() { return IScyllaDbCoreInterface::m_connectionData.strategy; };
         ...
         */
        EScyllaDbAuthMode getAuthMode() { return IScyllaDbCoreInterface::m_connectionData.auth_mode; }
