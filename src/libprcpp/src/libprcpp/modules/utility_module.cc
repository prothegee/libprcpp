...
void CUtilityModule::SJsonHelper::toFile(Json::Value &json, const std::string &filePath)
{
    try
    {
        ...
        pWriter->write(json, &output);
    }
    catch(const Json::Exception& e)
    {
        std::cerr << "ERROR jsonToFile: " << e.what() << '\n';
        abort();
    }
}

Json::Value CUtilityModule::SJsonHelper::fromFile(const std::string &filePath)
{
    Json::Value result;
    ...
    {
        std::cerr << "ERROR: can't find json file from filePath\n";
        abort();
    }
    f.close();
...
std::string CUtilityModule::SJsonHelper::toString(const Json::Value &input)
{
    std::string result;
...
Json::Value CUtilityModule::SJsonHelper::fromString(const std::string &input)
{
    Json::Value result;
